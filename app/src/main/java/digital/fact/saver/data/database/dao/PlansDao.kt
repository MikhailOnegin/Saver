...
interface PlansDao {
    ...
    fun getPlan(planId: Long): PlanTable?
    ...
    fun getPlansForAPeriod(periodStart: Long, periodEnd: Long): List<PlanTable>
    ...
    fun getCurrentPlans(periodStart: Long, periodEnd: Long): List<PlanTable>
