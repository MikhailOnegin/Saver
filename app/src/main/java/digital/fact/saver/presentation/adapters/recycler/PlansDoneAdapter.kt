...
class PlansDoneAdapter(
...
): ListAdapter<Plan, PlansDoneAdapter.PlanDoneViewHolder>(PlansDiffUtilCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlanDoneViewHolder {
        return PlanDoneViewHolder(LayoutPlanBinding.inflate(
    ...
    override fun onBindViewHolder(holderDone: PlanDoneViewHolder, position: Int) {
        holderDone.bind(currentList[position])
    }
    ...
    inner class PlanDoneViewHolder(private val binding: LayoutPlanBinding): RecyclerView.ViewHolder(binding.root){
